...
function Testimonials() {
  return (
    <div className='flex flex-col justify-center mt-36 bg-red-100'>
        <div className='text-orange-500'> OUR TESTIMONIAL</div>
        <div className='font-bold text-4xl'>People <span className='text-cyan-400 '>Say About</span> Eduhive</div>
